...
public static class CursorExtensions
{
    ...
    public static void EnableHoverCursor(this VisualElement element, CursorIcon cursor = CursorIcon.Arrow)
    {
        element.HandlerChanged += (s, e) =>
        {
            if (element.Handler?.MauiContext != null)
            {
                element.SetCustomCursor(cursor, element.Handler.MauiContext);
            }
        };
    }
